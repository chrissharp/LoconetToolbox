...
{
    /// <summary>
    /// Connector mode for an MGV133 with sensors connected to pin 5-8.
    /// </summary>
    public sealed class Mgv133HighPins : ConnectorMode
    {
        /// <summary>
        /// Default ctor
        /// </summary>
        public Mgv133HighPins()
            : base("MGV133 (pin 5-8)",
                4,
                new[] {
                    "Sensor 1",
